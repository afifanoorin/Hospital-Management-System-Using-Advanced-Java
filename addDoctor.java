        ...
        try {
           ...
           Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");//Loading Driver
              ...
              String npass=request.getParameter("npass");  
               ...
               String sql="insert into doctors(specilization,doctorName,address,docFees,contactno,docEmail,password,creationDate,updationDate) values(?,?,?,?,?,?,?,?,?)"; 
...
//                   int i1=ps1.executeUpdate();
                        response.sendRedirect("admin/add-doctor.jsp?mess=success");out.println("inserted");
                    
                    }
                else{ 
                    response.sendRedirect("admin/add-doctor.jsp?mess=error");out.println("error");
                }
