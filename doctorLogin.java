            ...
            out.println("Connected Successfully");
              ...
              String password= request.getParameter("password"); 
               long time = System.currentTimeMillis(); 
                ...
                int status=1;
                String sql ="SELECT  * FROM doctors WHERE doctorName=? and password=?";
                ...
                if(rs.next())
                    { 
                        ...
                        session.setAttribute("dname", rs.getString(3));  
                    ...
                    String log="insert into doctorslog(uid,username,userip,loginTime,logout,status) values(?,?,?,?,?,?)";
                    ...
                    //int i=ps1.executeUpdate();
                        ...
                        response.sendRedirect("doctor/dashboard.jsp?log=success"); 
                    }
                else{ 
                     InetAddress localhost = InetAddress.getLocalHost();
                        System.out.println("System IP Address : " +(localhost.getHostAddress()).trim());
...
//                     out.println("<script>alert('Invalid Details');</script>");
                    response.sendRedirect("doctor/index.jsp?log=error");out.println("error");
                }
