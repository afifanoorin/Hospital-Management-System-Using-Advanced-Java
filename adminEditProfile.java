            ...
            Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");//Loading Driver
              ...
              String email=request.getParameter("docemail");  
               ...
               long time = System.currentTimeMillis(); 
                ...
                int status=1;//
                int did= Integer.parseInt(session.getAttribute("didd").toString()); 
               ...
               String sql="Update doctors set specilization=?,doctorName=?,address=?,docFees=?,contactno=?,docEmail=?,updationDate=? where id=?"; 
                ...
                if(i!=0)
                    { 
                        response.sendRedirect("admin/manage-doctors.jsp?messe=success");out.println("inserted");
                    
                    }
                else{ 
                    response.sendRedirect("admin/manage-doctors.jsp?messe=error");out.println("error");
                }
