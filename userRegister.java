        ...
        Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");//Loading Driver
              ...
              String password_again= request.getParameter("password_again");  
               ...
               long time = System.currentTimeMillis(); 
                ...
                int status=1;//
                //("insert into users(fullname,address,city,gender,email,password) 
                String sql="INSERT INTO  users(fullname,address,city,gender,email,password,regDate) VALUES(?,?,?,?,?,?,?)";
                ...
                if(i!=0)
                    {
                    response.sendRedirect("hms/registration.jsp?mess=success");out.println("inserted");
                    }
                else{ 
                    response.sendRedirect("hms/registration.jsp?mess=error");out.println("error");
                }
